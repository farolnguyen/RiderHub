<?php
$page_css = "list_product_by_category.css";  // Đổi tên file CSS nếu cần
$page = "list_product_by_company"; 
include 'app/views/shares/header.php'; 
?>

<?php
$background_image = "/riderhub/uploads/companies/" . $company->name . ".jpg";  
?>
...
<div class="container mt-5 flex-grow-1 main-content" >
    <h1 class="text-center text-warning mb-4">
        Danh sách xe - <?php echo htmlspecialchars($company->name, ENT_QUOTES, 'UTF-8'); ?>
    </h1>   

    <?php if (empty($products)): ?>
        <p class="no-products">🚨 Chưa có xe nào từ hãng này.</p>
    <?php else: ?>
